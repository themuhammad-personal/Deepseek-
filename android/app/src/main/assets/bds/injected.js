...
`),"</BetterDeepSeek>"].join(`
`):""}const K=new Set(["the","a","an","and","or","but","if","then","else","when","at","by","for","with","about","against","is","it","was","were","are","be","been","between","into","through","during","before","after","above","below","to","from","up","down","in","out","on","off","over","under","again","further","once","here","there","all","any","both","each","few","more","most","other","some","such","no","nor","not","only","own","same","so","than","too","very","can","will","just","should","now","how","what","where","why","who","which","ve","veya","ama","fakat","lakin","ancak","ise","ki","de","da","mi","mu","m\xFC","m\u0131","bir","bu","\u015Fu","o","i\xE7in","gibi","kadar","ile","taraf\u0131ndan","hakk\u0131nda","kar\u015F\u0131","aras\u0131nda","i\xE7ine","boyunca","\xF6nce","sonra","\xFCzerinde","alt\u0131nda","yine","daha","en","t\xFCm","her","baz\u0131","hi\xE7","sadece","kendi","ayn\u0131","\xF6yle","b\xF6yle","\xE7ok","yap\u0131lan","yaparak","olan"]);function V(e,t=800,n=5){if(!e||!e.content)return[];const r=e.content.split(/\r?\n/);if(r.length===0)return[];const o=[];let a=0;for(;a<r.length;){const d=[];let s=0;const f=a+1;for(;a<r.length&&(s<t||d.length<3);)d.push(r[a]),s+=r[a].length+1,a++;const c=a;if(o.push({fileName:e.name,content:d.join(`
`),startLine:f,endLine:c}),a>=r.length)break;a=Math.max(f,a-n)}return o}function N(e){return e?(String(e).toLowerCase().match(/[a-z0-9_\u015f\u00e7g\u00f6\u0131\u00fc]+/gi)||[]).filter(n=>n.length>=2&&!K.has(n)):[]}function Q(e,t,n=5){if(!e||!t||!t.length)return[];const r=[];for(const y of t)r.push(...V(y,800,5));if(r.length===0)return[];const o=N(e);if(o.length===0)return[];const a=r.length,d=r.map(y=>N(y.content)),s=d.map(y=>y.length),c=s.reduce((y,k)=>y+k,0)/a||1,u={};for(const y of o){u[y]=0;for(const k of d)k.includes(y)&&u[y]++}const p=1.2,E=.75,x=[];for(let y=0;y<a;y++){const k=r[y],g=d[y],w=s[y];let i=0;const l={};for(const h of g)l[h]=(l[h]||0)+1;for(const h of o){const S=l[h]||0;if(S===0)continue;const b=u[h]||0,R=Math.log(1+(a-b+.5)/(b+.5))*(S*(p+1))/(S+p*(1-E+E*(w/c)));i+=R}const m=String(k.fileName).toLowerCase();for(const h of o)m.includes(h)&&(i+=12);i>0&&x.push({...k,score:i})}return x.sort((y,k)=>k.score-y.score).slice(0,Math.max(1,n))}function Z(e,t="Project"){if(!e||!e.length)return"";let n=`<BDS:PROJECT_CONTEXT>
...
`):typeof e.prompt=="string"?e.prompt:"":""}function v(e,t){if(e){if(typeof e.content=="string"||e.content==null){e.content=t;return}if(Array.isArray(e.content)){e.content=[{type:"text",text:t}];return}if(typeof e.prompt=="string"){e.prompt=t;return}e.content=t}}function ne(e,t=null){if(!Array.isArray(e))return!1;for(const n of e){if(n===t)continue;if(A(n).includes("<BetterDeepSeek>"))return!0}return!1}function _(e,t,n,r=!1,o=null,a=null){var l,m;const d=[],s=re(e,t,n);s&&d.push(s);const f=Ee(n);f&&d.push(f);const c=ke(n);c&&(d.push(c),(l=n.config)!=null&&l.deepCode&&(n.config.deepCode.pendingReport=null),typeof window<"u"&&window.dispatchEvent(new CustomEvent("bds:clear-harness-report")));const u=n.config.systemPromptEntries||[];if(u.length>0){const h=n.sessionUserMsgCounts[t]||1;for(const S of u)S.content.trim()&&ge(S,h,t,n)&&(d.push(`<BetterDeepSeek>
${S.content.trim()}
</BetterDeepSeek>`),n.markEntryInjected&&n.markEntryInjected(t,S.id))}else r&&n.config.systemPrompt.trim()&&!n.config.disableSystemPrompt&&(d.push(`<BetterDeepSeek>
${n.config.systemPrompt.trim()}
</BetterDeepSeek>`),n.markInjected&&n.markInjected(t));const p=P(n.config.skills);let E=null;if(!r&&o&&(E=ye(o,a)),r||p&&p!==E){const h=ie(n);h&&d.push(h)}const x=ue(e,n,o);x&&d.push(x);const y=Y(e);y&&d.push(y);const k=n.config.activeCharacter;if(k){let h=o?Se(o,a):null;if(!h&&n.getLastChar&&(h=n.getLastChar(t)),!h&&n.currentSessionChar&&(o==null?void 0:o.length)>1&&(h=n.currentSessionChar),r||!h||h!==k.name){const S=fe(n);S&&(d.push(S),n.setLastChar&&n.setLastChar(t,k.name),n.currentSessionChar=k.name)}}n.isNextVoiceMessage&&(d.push("<BetterDeepSeek>User send this message using voice recorder tool.</BetterDeepSeek>"),n.isNextVoiceMessage=!1);const g=n.config&&n.config.activeProject;if(g){let h=null;if(!r&&o&&(h=be(o,a)),r||!h||h!==g.name){const S=he(n);S&&d.push(S)}if(n.config.projectRagEnabled&&Array.isArray(g.files)&&g.files.length>0){const S=Number(n.config.projectRagLimit)||5,b=Q(e,g.files,S);if(b&&b.length>0){const T=Z(b,g.name);T&&d.push(T)}}}if(r){const h=pe(n);h&&d.push(h)}const w=se((m=n.config)==null?void 0:m.mcpToolSchemas);let i=null;if(!r&&o&&(i=we(o,a)),r||w&&w!==i){const h=me(n,w);h&&d.push(h)}return d.join(`
...
`),d="</BDS:MCP> </BetterDeepSeek>",s=n.map(i=>{let l=`- Server: ${i.serverName} (${i.serverUrl||i.serverName}) | Tool: ${i.toolName}`;if(i.description&&(l+=` | Description: ${i.description}`),i.inputSchema&&typeof i.inputSchema=="object"){const m=i.inputSchema.properties;if(m){const h=Object.entries(m).map(([S,b])=>{const T=(i.inputSchema.required||[]).includes(S)?" (required)":"";return`${S}: ${(b==null?void 0:b.type)||"any"}${T}`});h.length&&(l+=` | Params: ${h.join(", ")}`)}}return l}),f=[a,...s,d].join(`
`);if(f.length<=r)return f;const c=i=>`
... and ${i} more tool(s) not shown (MCP tool list exceeds inline character limit \u2014 all tools are still available for invocation).`,u=c(1),p=a.length+1+d.length+u.length;let E=r-p;const x=[];for(const i of s){const l=i.length+1;if(E-l<0)break;E-=l,x.push(i)}const y=o-x.length,k=c(y);let g=[a,...x,k,d].join(`
...
</BetterDeepSeek>`}function xe(e,t,n,r){const o=window.fetch;window.fetch=async function(d,s){try{const f=Ae(d);if(!t(f))return o.apply(this,arguments);if(Le(d,s,e),f.includes("/api/v0/chat_session/fetch_page")){const c=await o.apply(this,arguments);return c.clone().json().then(p=>{window.dispatchEvent(new CustomEvent("bds:session-data",{detail:JSON.stringify(p)}))}).catch(()=>{}),c}if(f.includes("/api/v0/chat/history_messages")){const c=await o.apply(this,arguments);return c.clone().json().then(p=>{window.dispatchEvent(new CustomEvent("bds:history-msgs",{detail:JSON.stringify(p)}))}).catch(()=>{}),c}n(f);try{const c=await Re(d,s,e);if(!c){const p=await o.apply(this,arguments);return C(p,f,c==null?void 0:c.modelName),p}let u;try{u=await o.call(this,c.input,c.init)}catch(p){return console.warn("[BetterDeepSeek] Mutated fetch failed, retrying original fetch:",p),u=await o.apply(this,arguments),C(u,f,c==null?void 0:c.modelName),u}if(u&&u.status>=400&&u.status<500){console.warn("[BetterDeepSeek] Mutated fetch returned HTTP "+u.status+", retrying original request...");try{const p=await o.apply(this,arguments);return C(p,f,c==null?void 0:c.modelName),p}catch(p){console.error("[BetterDeepSeek] Fallback fetch failed:",p)}}return u&&u.status>=500&&window.dispatchEvent(new CustomEvent("bds:network-error",{detail:JSON.stringify({url:f,status:u.status,type:"fetch"})})),C(u,f,c.modelName),u}catch(c){console.warn("[BetterDeepSeek] Fetch patch inner error, falling back to original fetch:",c);try{return await o.apply(this,arguments)}catch(u){throw window.dispatchEvent(new CustomEvent("bds:network-error",{detail:JSON.stringify({url:f,status:0,type:"fetch",error:String(u)})})),u}}finally{r(f)}}catch(f){return console.warn("[BetterDeepSeek] Request patch failed:",f),o.apply(this,arguments)}}}function C(e,t,n){if(!(!e||!e.clone))try{const r=e.clone();Ce(r,n).catch(()=>{})}catch{}}function Ae(e){return typeof e=="string"?e:e instanceof URL?e.toString():e instanceof Request?e.url:""}async function Re(e,t,n){const r=await De(e,t);if(!r)return null;let o;try{o=JSON.parse(r)}catch{return null}const a=o.model||null,d=I(o,n);if(!d.changed)return null;const s=JSON.stringify(d.payload),f=t&&t.headers?t.headers:e instanceof Request?e.headers:void 0,c=new Headers(f||{});c.set("content-type","application/json");const u={method:t&&t.method||(e instanceof Request?e.method:"POST"),headers:c,body:s,credentials:t&&t.credentials||(e instanceof Request?e.credentials:void 0),cache:t&&t.cache||(e instanceof Request?e.cache:void 0),mode:t&&t.mode||(e instanceof Request?e.mode:void 0),redirect:t&&t.redirect||(e instanceof Request?e.redirect:void 0),referrer:t&&t.referrer||(e instanceof Request?e.referrer:void 0),referrerPolicy:t&&t.referrerPolicy||(e instanceof Request?e.referrerPolicy:void 0),keepalive:t&&t.keepalive||(e instanceof Request?e.keepalive:void 0),integrity:t&&t.integrity||(e instanceof Request?e.integrity:void 0),signal:t&&t.signal||(e instanceof Request?e.signal:void 0)};return{input:typeof e=="string"||e instanceof URL?e:e.url,init:u,modelName:a}}async function Ce(e,t){try{const n=e.headers.get("content-type")||"";if(n.includes("text/event-stream")||n.includes("stream"))await ve(e,t);else{const r=await e.text();try{const o=JSON.parse(r),a=(o==null?void 0:o.usage)||(o==null?void 0:o.token_usage);a&&M(a.prompt_tokens||a.input_tokens||0,a.completion_tokens||a.output_tokens||0,t)}catch{}}}catch{}}async function ve(e,t){var d;const n=(d=e.body)==null?void 0:d.getReader();if(!n)return;const r=new TextDecoder;let o="";try{for(;;){const{done:s,value:f}=await n.read();if(f&&(o+=r.decode(f,{stream:!s})),s)break}}catch{return}const a=o.split(`
`);for(let s=a.length-1;s>=0;s--){const f=a[s].trim();if(!f.startsWith("data: "))continue;const c=f.slice(6).trim();if(c!=="[DONE]")try{const u=JSON.parse(c),p=(u==null?void 0:u.usage)||(u==null?void 0:u.token_usage);if(p){M(p.prompt_tokens||p.input_tokens||0,p.completion_tokens||p.output_tokens||0,t||(u==null?void 0:u.model));break}}catch{}}}function M(e,t,n){typeof e!="number"&&typeof t!="number"||window.dispatchEvent(new CustomEvent("bds:token-usage",{detail:JSON.stringify({inputTokens:Number(e)||0,outputTokens:Number(t)||0,modelName:n||null,timestamp:Date.now()})}))}async function De(e,t){return t&&typeof t.body=="string"?t.body:t&&t.body instanceof URLSearchParams?t.body.toString():e instanceof Request?e.clone().text():""}function Le(e,t,n){try{let r;if(t&&t.headers){const o=t.headers;if(o instanceof Headers)r=o.get("authorization");else if(Array.isArray(o)){for(const[a,d]of o)if(a.toLowerCase()==="authorization"){r=d;break}}else typeof o=="object"&&(r=o.Authorization||o.authorization)}!r&&e instanceof Request&&(r=e.headers.get("authorization")),r&&typeof(n==null?void 0:n.setAuthToken)=="function"&&n.setAuthToken(r)}catch{}}function Ne(e,t,n,r){const o=XMLHttpRequest.prototype.open,a=XMLHttpRequest.prototype.send,d=XMLHttpRequest.prototype.setRequestHeader;XMLHttpRequest.prototype.open=function(f,c){return this.__bdsRequestMeta={method:String(f||"GET").toUpperCase(),url:String(c||"")},o.apply(this,arguments)},XMLHttpRequest.prototype.setRequestHeader=function(f,c){return f&&String(f).toLowerCase()==="authorization"&&typeof(e==null?void 0:e.setAuthToken)=="function"&&e.setAuthToken(String(c||"")),d.apply(this,arguments)},XMLHttpRequest.prototype.send=function(f){try{const c=this.__bdsRequestMeta||{};if(!t(c.url))return a.call(this,f);if(c.url.includes("/api/v0/chat_session/fetch_page"))return this.addEventListener("load",()=>{try{const i=JSON.parse(this.responseText);window.dispatchEvent(new CustomEvent("bds:session-data",{detail:JSON.stringify(i)}))}catch{}}),a.call(this,f);if(c.url.includes("/api/v0/chat/history_messages"))return this.addEventListener("load",()=>{try{const i=JSON.parse(this.responseText);window.dispatchEvent(new CustomEvent("bds:history-msgs",{detail:JSON.stringify(i)}))}catch{}}),a.call(this,f);n(c.url);let u=!1;const p=()=>{u||(u=!0,(this.status>=500||this.status===0)&&window.dispatchEvent(new CustomEvent("bds:network-error",{detail:JSON.stringify({url:c.url,status:this.status,type:"xhr"})})),r(c.url))};this.addEventListener("loadend",p,{once:!0});const E=Ie(f);if(!E)return a.call(this,f);const x=JSON.parse(E),y=x.model||null,k=I(x,e);if(!k.changed)return a.call(this,f);const g=JSON.stringify(k.payload),w=this;return this.addEventListener("load",()=>{try{const i=w.responseText;i&&Oe(i,w,y)}catch{}},{once:!0}),a.call(this,g)}catch(c){const u=this.__bdsRequestMeta||{};console.warn("[BetterDeepSeek] XHR patch failed:",c);try{return a.call(this,f)}catch(p){throw t(u.url)&&r(u.url),p}}}}function Ie(e){return typeof e=="string"?e:e instanceof URLSearchParams?e.toString():""}function Oe(e,t,n){var r;try{if((((r=t.getResponseHeader)==null?void 0:r.call(t,"content-type"))||"").includes("text/event-stream")||e.startsWith("data: ")){const a=e.split(`
`);for(let d=a.length-1;d>=0;d--){const s=a[d].trim();if(!s.startsWith("data: "))continue;const f=s.slice(6).trim();if(f!=="[DONE]")try{const c=JSON.parse(f),u=c==null?void 0:c.usage;if(u){window.dispatchEvent(new CustomEvent("bds:token-usage",{detail:JSON.stringify({inputTokens:u.prompt_tokens||u.input_tokens||0,outputTokens:u.completion_tokens||u.output_tokens||0,modelName:n||(c==null?void 0:c.model)||null,timestamp:Date.now()})}));break}}catch{}}}}catch{}}(function(){"use strict";const e={configUpdate:"bds:config-update",deepResearchConfigUpdate:"bds:deep-research-config-update",requestConfig:"bds:request-config",markVoiceMessage:"bds:mark-voice-message",sessionData:"bds:session-data"},t="/api/v0/chat_session/fetch_page",n="/api/v0/chat/history_messages",r="/api/v0/chat/completion";function o(){try{return JSON.parse(localStorage.getItem("bds_injected_chats")||"[]")}catch{return[]}}function a(i){const l=o();l.includes(i)||(l.push(i),l.length>50&&l.shift(),localStorage.setItem("bds_injected_chats",JSON.stringify(l)))}function d(){try{return JSON.parse(localStorage.getItem("bds_injected_chars")||"{}")}catch{return{}}}function s(i,l){const m=d();m[i]=l;const h=Object.keys(m);h.length>50&&delete m[h[0]],localStorage.setItem("bds_injected_chars",JSON.stringify(m))}function f(i){try{return JSON.parse(localStorage.getItem("bds_injected_entries")||"{}")[i]||[]}catch{return[]}}function c(i,l){try{const m=JSON.parse(localStorage.getItem("bds_injected_entries")||"{}");m[i]||(m[i]=[]),m[i].includes(l)||m[i].push(l);const h=Object.keys(m);h.length>50&&delete m[h[0]],localStorage.setItem("bds_injected_entries",JSON.stringify(m))}catch{}}function u(){var i,l;try{for(let h=0;h<localStorage.length;h++){const S=localStorage.key(h);if(S&&/token|auth|session/i.test(S)){const b=localStorage.getItem(S);if(!b)continue;if(b.trim().startsWith("{"))try{const T=JSON.parse(b),R=T.token||T.accessToken||T.access_token||T.user_token||((i=T.user)==null?void 0:i.token);if(R&&typeof R=="string")return R}catch{}else if(typeof b=="string"&&b.length>20){let T=b;return T.startsWith("Bearer ")&&(T=T.substring(7)),T.startsWith('"')&&T.endsWith('"')&&(T=T.slice(1,-1)),T}}}const m=(l=document.cookie.split("; ").find(h=>h.startsWith("user_token=")||h.startsWith("token=")))==null?void 0:l.split("=")[1];if(m)return decodeURIComponent(m)}catch(m){console.warn("[BDS] Failed to search auth token in storage:",m)}return null}const p={config:{systemPrompt:"",systemPromptEntries:[],skills:[],memories:[],activeCharacter:null,mcpToolSchemas:[]},hasInjected:i=>o().includes(i),markInjected:i=>a(i),getInjectedEntries:i=>f(i),markEntryInjected:(i,l)=>c(i,l),getLastChar:i=>d()[i]||null,setLastChar:(i,l)=>s(i,l),currentSessionChar:null,activeCompletionRequests:0,isNextVoiceMessage:!1,authToken:u(),setAuthToken:function(i){i&&i!==this.authToken&&(this.authToken=i)}};if(window.__bdsNetworkPatched)return;window.__bdsNetworkPatched=!0,(function(){if(window.__BDS_CONFIG__)return;let i=0;const l=new Map;window.addEventListener("bds:debug-api-response",h=>{let S=h.detail;if(typeof S=="string")try{S=JSON.parse(S)}catch{return}const b=l.get(S.id);b&&(b(S.result),l.delete(S.id))});function m(h){return function(){const S=Array.from(arguments);return new Promise(b=>{const T=++i;l.set(T,b),window.dispatchEvent(new CustomEvent("bds:debug-api-request",{detail:JSON.stringify({id:T,method:h,args:S})}))})}}window.__BDS_CONFIG__={raw:m("getRaw"),getFlag:m("getFlag"),getConfig:m("getConfig"),applyRemote:m("applyRemote"),replaceRemote:m("replaceRemote"),resetToBuiltin:m("resetToBuiltin"),detectModel:m("detectModel"),toggleDebugPanel:m("toggleDebugPanel")}})(),window.addEventListener(e.configUpdate,i=>{let l=i&&i.detail?i.detail:{};if(typeof l=="string")try{l=JSON.parse(l)}catch(m){console.error("[BDS] Failed to parse configUpdate detail:",m)}p.config=H(l||{})}),window.addEventListener(e.deepResearchConfigUpdate,i=>{let l=i&&i.detail?i.detail:{};if(typeof l=="string")try{l=JSON.parse(l)}catch(m){console.error("[BDS] Failed to parse deepResearchConfigUpdate detail:",m)}p.config.deepResearch=D(l||{})}),window.addEventListener(e.markVoiceMessage,()=>{p.isNextVoiceMessage=!0}),window.addEventListener("bds:request-history-msgs",async i=>{let l=i&&i.detail?i.detail:{};if(typeof l=="string")try{l=JSON.parse(l)}catch{return}const m=l==null?void 0:l.sessionId;if(!m)return;const h=`${n}?chat_session_id=${encodeURIComponent(m)}`,S={"Content-Type":"application/json"};p.authToken&&(S.Authorization=`Bearer ${p.authToken}`);try{const b=await E(h,{method:"GET",headers:S,credentials:"include"});if(!b.ok){console.warn("[BDS] history_mgs fetch failed:",b.status);return}const T=await b.json();T.__bdsExplicit=!0,window.dispatchEvent(new CustomEvent("bds:history-msgs",{detail:JSON.stringify(T)}))}catch(b){console.warn("[BDS] history_msgs fetch error:",b)}}),x();const E=window.fetch.bind(window);xe(p,y,g,w),Ne(p,y,g,w);function x(){window.dispatchEvent(new CustomEvent(e.requestConfig))}function y(i){const l=String(i||"");return l.includes("/api/v0/chat/completion")||l.includes("/api/v0/chat/edit_message")||l.includes(t)||l.includes(n)}function k(i,l){const m={status:i,url:String(l||""),activeCompletionRequests:p.activeCompletionRequests,timestamp:Date.now()};window.dispatchEvent(new CustomEvent(e.networkState,{detail:JSON.stringify(m)}))}function g(i){p.activeCompletionRequests+=1,k("start",i)}function w(i){p.activeCompletionRequests=Math.max(0,p.activeCompletionRequests-1),k("end",i)}})()})();
