...
/**
 * Injects a clean, native-styled Better DeepSeek tool button into the top header bar.
 * Replaces intrusive floating buttons on mobile and gives Claude-like header access.
 */
